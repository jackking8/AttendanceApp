    ...
    private void setUserDetails(){
        ...
        if(user != null){
            UserProfileChangeRequest profileUpdates = new UserProfileChangeRequest.Builder()
                    .setDisplayName("Jack King")
                    .setPhotoUri(Uri.parse("https://www.almacgroup.com/news/almac-discovery-mcclay-foundation" +
                            "-and-ulster-university-join-forces-to-explore-diseases-of-the-eye/"))
                    .build();
